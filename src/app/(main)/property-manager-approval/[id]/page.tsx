    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 text-xs font-semibold text-gray-500">
        <Link
          ...
          className="px-3 py-2.5 bg-[#EBEBEB] hover:bg-gray-100 border border-gray-300/60 rounded-md text-gray-700 flex items-center gap-1.5 transition-colors"
        >
      ...
      {/* Top Header Card */}
      <div className="bg-[#EBEBEB] border border-gray-300/50 rounded-2xl p-6 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-[#EBEBEB] border border-gray-300/50 rounded-2xl p-6 shadow-xs space-y-4">
        ...
        <div className="bg-[#EBEBEB] border border-gray-300/50 rounded-2xl p-6 shadow-xs space-y-3">
            ...
            return (
              <div
                ...
                className={`p-3 rounded-xl flex items-center justify-between text-xs transition-colors ${pt.active
                  ...
                  : "bg-gray-200/60 text-gray-500 font-medium"
                  }`}
              >
